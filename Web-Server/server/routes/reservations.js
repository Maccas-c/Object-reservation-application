...
router.delete('/reservation/delete/:reservationId', async (req,res) =>{
  try{
    const deleteReservation = await reservationModel.remove({_id: req.params.reservationId})
...
router.get('/reservation/:reservationId', async (req, res) =>{
  try{
    const getReservation = await reservationModel.findById(req.params.reservationId);
